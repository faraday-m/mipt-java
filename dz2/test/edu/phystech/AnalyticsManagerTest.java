...
public class AnalyticsManagerTest {
    ...
    public void getMostFrequentBenefitiary_returnsTopBeneficiary_whenCalled() {
        //given
        Account freqBeneficiary = new Account(1, transactionManager);
        Account otherBeneficiary = new Account(2, transactionManager);
        Account originator = new Account(2, transactionManager);
